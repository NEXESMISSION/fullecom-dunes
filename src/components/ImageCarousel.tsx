...
export default function ImageCarousel({ images, autoPlayInterval = 3000 }: ImageCarouselProps) {
  ...
  if (images.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-8 pt-20 lg:pt-28 pb-3">
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 pt-20 lg:pt-28 pb-3">
      <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] md:aspect-[3/1] overflow-hidden bg-gray-100">
